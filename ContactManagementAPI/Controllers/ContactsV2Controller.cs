...
{
    /// <summary>
    /// Controller for managing contacts in API version 2.0
    /// </summary>
    [Authorize]
    [ApiVersion("2.0")]
    ...
    public class ContactsV2Controller : ControllerBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContactsV2Controller"/> class
        /// </summary>
        ...
        /// <summary>
        /// Gets all contacts with optional filtering and sorting (v2)
        /// </summary>
        ...
        /// <returns>A list of contacts with enhanced metadata</returns>
        /// <response code="200">Returns the list of contacts with metadata</response>
        ...
        /// <summary>
        /// Gets a specific contact by ID (v2)
        /// </summary>
        ...
        /// <summary>
        /// Gets a paged list of contacts with optional filtering and sorting (v2)
        /// </summary>
        /// <param name="name">Filter by contact name</param>
        /// <param name="city">Filter by city</param>
        /// <param name="state">Filter by state (2 letter code)</param>
        ...
        /// <summary>
        /// Updates an existing contact (v2)
        /// </summary>
        ...
        /// <summary>
        /// Partially updates a contact (v2)
        /// </summary>
        /// <param name="id">The ID of the contact to update</param>
        ...
        /// <summary>
        /// Gets a summary of contacts by state (v2 only endpoint)
        /// </summary>
